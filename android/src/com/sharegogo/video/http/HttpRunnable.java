 ...
 * {@link #HttpRunnable(TaskRunnableDownloadMethods) HttpRunnable()} with
...
class HttpRunnable implements Runnable {
    ...
    private static final String LOG_TAG = "HttpRunnable";
    ...
    final TaskRunnableHttpMethods mHttpTask;
    
    /**
     *
     * An interface that defines methods that PhotoTask implements. An instance of
     * PhotoTask passes itself to an HttpRunnable instance through the
     * HttpRunnable constructor, after which the two instances can access each other's
     * variables.
     */
    ...
    /**
     * This constructor creates an instance of HttpRunnable and stores in it a reference
     * to the PhotoTask instance that instantiated it.
     *
     * @param photoTask The PhotoTask, which implements TaskRunnableDecodeMethods
     */
    HttpRunnable(TaskRunnableHttpMethods httpTask) {
        mHttpTask = httpTask;
    }
    ...
    public void run() {
         ...
         */
    	mHttpTask.setHttpThread(Thread.currentThread());
        ...
        try {
             ...
             * decoded.
             */
            mHttpTask.handleHttpState(HTTP_STATE_COMPLETED);
        ...
        // In all cases, handle the results
            ...
            if (null == byteBuffer) {
            	mHttpTask.handleHttpState(HTTP_STATE_FAILED);
            }
